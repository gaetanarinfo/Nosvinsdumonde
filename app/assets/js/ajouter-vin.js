...
$(document).on('click', '#save', function (e) {
    ...
    $.ajax({
        url: '../app/ajax/ajax-blocAdd1.php',
        type: 'POST',
        data: formData,
    ...
    $.ajax({
        url: '../app/ajax/ajax-blocAdd2.php',
        type: 'POST',
        data: formData2,
        success: function (data) {}
    ...
    $.ajax({
        url: '../app/ajax/ajax-blocAdd3.php',
        type: 'POST',
        data: form_data3,
    ...
    $.ajax({
        url: '../app/ajax/ajax-blocAdd4.php',
        type: 'POST',
        data: formData4,
        success: function (data) {}
    ...
    $.ajax({
        url: '../app/ajax/ajax-blocAdd5.php',
        type: 'POST',
        data: form_data5,
        enctype: "multipart/form-data",
        processData: false,
