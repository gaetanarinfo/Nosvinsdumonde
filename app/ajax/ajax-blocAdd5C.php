    ...
    if (!empty($vin)) {
        ...
        if (!empty($_FILES)) {
            ...
            if (!in_array($ext, $valid_extensions)) {
                ...
                array_push($attachement, $_SERVER['DOCUMENT_ROOT'] . '/assets/img/champagnes/' . $file_name);
                array_push($attachements, 'assets/img/champagnes/' . $file_name);

                move_uploaded_file($fichier['file_0']['tmp_name'], $_SERVER['DOCUMENT_ROOT'] . '/assets/img/champagnes/' . $file_name);
            }
            ...
            if ($final['success']) {
                ...
                $attachemens = str_replace('assets/img/champagnes/', '', $attachemens);
