        ...
        <div class="col">
            ...
            <div class="row align-items-start">
                ...
                <div id="bloc_descriptif" class="col pe-5 pb-3">
                    ...
                    <div class="m-auto text-white"><span><?= $vin['apellationBoisson'] ?></span></div>
                    <div class="m-auto text-white"><span><?= $vin['couleurBoisson'] ?></span><span> | </span><span><?= $vin['degreeBoisson'] ?></span><span>°</span></div>
                ...
                <div class="col ps-5">
                    ...
                    <h3 class="text-white text-end no_border"><?= number_format($vin['prixBoisson'], 2, ',', '') ?><span> €</span></h3>
    ...
    <div class="text-center mb-5">
        ...
        <div class="row align-items-start">
            ...
            <div class="col">
                ...
                <h3 class="text-white text-bold no_border"><?= mb_strtoupper($vin['nomBoisson']) ?></h3>

                <p class="text-white mt-3">
                    <?= nl2br($vin['contentDefinitionBoisson']) ?>
                </p>
            ...
            <div class="col">
                ...
                <img style="max-width: 315px;" data-fancybox role="button" src="<?= $static_img ?>domaine_images/<?= $vin['domaineImageBoisson'] ?>">
                ...
                <div class="col mt-5">
                    ...
                    <script>
                        ...
                        const myChart = new Chart(ctx, {
                            type: 'doughnut',
                            data: {
                                labels: [<?= $vin['chartContentCepagesBoisson'] ?>],
                                datasets: [{
