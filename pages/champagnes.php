...
<div class="container-md mt-5 mb-5">
    ...
    <div class="row align-items-start">
        ...
        <div id="presentation_vin" class="col-md-3">
            ...
            <?php if ($champagne['planBoisson'] >= 1) { ?>
                <div class="vin_plan position-absolute">
                    <span>-<?= $champagne['planPourcentBoisson'] ?>%</span>
        ...
        <div class="col">
            ...
            <div class="row align-items-start">
                ...
                <div id="bloc_descriptif" class="col pe-5 pb-3">
                    ...
                    <?php if ($champagne['regionBoisson'] != "") { ?><div class="m-auto"><span class="badge_region"><?= $champagne['regionBoisson'] ?></span></div><?php } ?>
                    <?php if ($champagne['apellationBoisson'] != "") { ?><div class="m-auto text-white"><span><?= $champagne['apellationBoisson'] ?></span></div><?php } ?>
                    <div class="m-auto text-white"><?php if ($champagne['couleurBoisson'] != "") { ?><span><?= $champagne['couleurBoisson'] ?></span><span> | </span><?php } ?><span><?= $champagne['degreeBoisson'] ?></span><span>°</span></div>
                ...
                <div class="col ps-5">
                    ...
                    <h3 class="text-white text-end no_border"><?= ($champagne['planBoisson'] >= 1) ? '<span class="text-warning text-decoration-line-through me-2" style="font-size: 18px;">' . number_format($champagne['prixBoisson'], 2, ',', '') . ' €</span> ' . number_format($champagne['remiseBoisson'], 2, ',', '') : number_format($champagne['prixBoisson'], 2, ',', '') ?><span> €</span></h3>
                    ...
                    <div class="text-end mt-3">
                        <?php if ($champagne['stockBoisson'] >= 1) { ?>
    ...
    <div class="text-center mb-5">
        ...
        <div class="row align-items-start">
            ...
            <?php if ($champagne['contentDefinitionBoisson'] != "") { ?>

                <div class="col text-white">

                    <h3 class="text-white text-bold no_border"><?= htmlspecialchars_decode($champagne['nomBoisson']) ?></h3>

                    <p class="text-white mt-3">
                        <?= htmlspecialchars_decode($champagne['contentDefinitionBoisson']) ?>
                    </p>
            ...
            <div class="col">
                ...
                <img style="max-width: 295px;" data-fancybox role="button" src="<?= $static_img ?>domaine_images/<?= $champagne['domaineImageBoisson'] ?>">
        ...
        <?php if ($champagne['cepagesBoisson'] == 1) { ?>
            ...
            <div class="row align-items-start">
                ...
                <div class="col mt-5">
                    ...
                    $array = explode(',', $champagne['chartContentCepagesBoisson']);
                    $tableau = '';
