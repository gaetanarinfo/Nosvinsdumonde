                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <div class="m-auto prix"><span><span class="chiffre"><?= ($selection['planBoisson'] >= 1) ? number_format($selection['remiseBoisson'], 2, ',', '') : '<span class="text-warning text-decoration-line-through me-2" style="font-size: 18px;">' . number_format($selection['prixBoisson'], 2, ',', '') . ' €</span> ' . number_format($selection['prixBoisson'], 2, ',', '') ?> €</div>
